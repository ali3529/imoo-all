        ...
        try {
          ...
          Log::error($request->all());
            $data = [
                ...
                'name'              => Str::title((''.$request->get('type')['name'].' - '
    ...
    protected function validateCreate(Request $request)
    {
        $request->validate([
            ...
            /*
                        ...
                        'number_floor'      => 'integer|min:-100|max:10000|required',
...
//            'contact_phone_number' => 'numeric|required',
            ...
            'square'              => 'numeric|min:1|required',
            'number_wc'           => 'numeric|min:0|max:1000|required',
            'construction_year'   => 'numeric|min:1600|max:2022|required',
            'last_renovation'     => 'numeric|min:2000|max:2022|nullable',
            'last_reconstruction' => 'numeric|min:2000|max:2022|nullable',
            'available_date'      => 'max:100',
            //END Edited

            'number_bathroom' => 'numeric|min:0|max:10000|required',
             'number_floor'    => 'regex:/^([+-](?=\.?\d))?(\d+)?(\.\d+)?$/|required',  
