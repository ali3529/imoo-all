<template>
  ...
  <b-alert show variant="warning">
    <h2 class="alert-heading center">{{ $t('Verify Email Address!') }}</h2>
    <hr>
    <p>
          <h4>   if you don't receive email: </h4>
     Please check your <strong>spam </strong> or <strong>junk </strong> mail folder 
    </p>
    <hr>
    <p class="mb-0">
      Email To Support : immo@immoall.ch
    </p>
  </b-alert>
</div>
